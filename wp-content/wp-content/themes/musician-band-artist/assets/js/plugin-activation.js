jQuery(document).ready(function($) {
    'use strict';
    var this_obj = musician_band_artist_plugin_activate_plugin;
    ...
    $(document).on('click', '.musician-band-artist-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message musician-band-artist-plugin-install');
                button.addClass('button-primary musician-band-artist-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.musician-band-artist-recommended-plugins .musician-band-artist-activation-note').css('display','block');
    ...
    $(document).on('click', '.musician-band-artist-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .musician-band-artist-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .musician-band-artist-recommended-plugins').css('display','none');
    });
